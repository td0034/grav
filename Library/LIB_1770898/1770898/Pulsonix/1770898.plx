...
(library Library_1
	...
	(patternDef "1770898" (originalName "1770898")
		...
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt 1.700, 2.200) (textStyleRef "Normal") (isVisible True))
		)
		(layerContents (layerNumRef 28)
			(line (pt -2.5 7.2) (pt 5.5 7.2) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 5.5 7.2) (pt 5.5 -2.8) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 5.5 -2.8) (pt -2.5 -2.8) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -2.5 -2.8) (pt -2.5 7.2) (width 0.025))
		)
	...
	(compDef "1770898" (originalName "1770898") (compHeader (numPins 6) (numParts 1) (refDesPrefix J)
		...
		(attr "<Hyperlink>" "http://uk.rs-online.com/web/p/products/7124579")
		(attr "<Component Height>" "5.1")
		(attr "<STEP Filename>" "1770898.stp")
