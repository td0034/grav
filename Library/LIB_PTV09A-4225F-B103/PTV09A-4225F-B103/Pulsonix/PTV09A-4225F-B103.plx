...
(library Library_1
	...
	(patternDef "PTV09A4020FB103" (originalName "PTV09A4020FB103")
		...
		(layerContents (layerNumRef 28)
			(line (pt -4.85 6.9) (pt 4.85 6.9) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 4.85 6.9) (pt 4.85 -5.6) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 4.85 -5.6) (pt -4.85 -5.6) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -4.85 -5.6) (pt -4.85 6.9) (width 0.025))
		)
	...
	(compDef "PTV09A-4225F-B103" (originalName "PTV09A-4225F-B103") (compHeader (numPins 5) (numParts 1) (refDesPrefix R)
		...
		(attr "<Hyperlink>" "http://uk.rs-online.com/web/p/products/8274990P")
		(attr "<Component Height>" "20")
		(attr "<STEP Filename>" "PTV09A-4225F-B103.stp")
		(attr "<STEP Offsets>" "X=0;Y=0.8;Z=4.36")
