...
//525990/55039/2.49/8/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "LM833MM_NOPB" (originalName "LM833MM_NOPB")
	...
	(compDef "LM833MM_NOPB" (originalName "LM833MM_NOPB") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "4" (pinName "-VEE") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "LM833MM_NOPB"))
		...
		(attr "RS Part Number" "9142989P")
		(attr "RS Price/Stock" "http://uk.rs-online.com/web/p/products/9142989P")
		(attr "Manufacturer_Name" "Texas Instruments")
		(attr "Manufacturer_Part_Number" "LM833MM/NOPB")
		(attr "Description" "Texas Instruments LM833MM/NOPB, Dual Audio Op Amp, 15MHz, Maximum of 36 V, 8-Pin VSSOP")
		(attr "<Hyperlink>" "http://uk.rs-online.com/web/p/products/9142989P")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "LM833MM_NOPB.stp")
